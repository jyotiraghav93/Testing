        ...
        <table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
            <tr>
                <td nowrap="nowrap" class='paginationActionButtons'>
                    ...
                    <a href="index.php?module=Administration&action=KanbanConf" class="glyphicon glyphicon-cog" style="display: inline-block; padding: 6px 8px; background: #94a6b5; border-radius: 4px; color: #ffffff;"></a>
